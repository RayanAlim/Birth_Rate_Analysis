...
Although the code used in the original paper is Strata, we use R[@citeR]
...
# References
@Dataset{ukcprWelfareData,
  title = {UKCPR National Welfare Data, 1980-2021},
  author = {{University of Kentucky Center for Poverty Research}},
  year = {2023},
  month = {Feb},
  address = {Lexington, KY},
  url = {http://ukcpr.org/resources/national-welfare-data%7D,
...
@InBook{Grundy2015Demography,
  author    = {Emily Grundy and Michael Murphy},
  editor    = {Roger Detels and Martin Gulliford and Quarraisha Abdool Karim and Chorh Chuan Tan},
  title     = {Demography and public health},
...
@Article{thereferencecanbewhatever,
  ...
  @Article{Nargund2009DecliningBirthRate,
...
@Article{delondras2022impact,
  title = {The impact of mandatory waiting periods on abortion-related outcomes: a synthesis of legal and health evidence},
  author = {Fiona de Londras and Amanda Cleeve and Maria I. Rodriguez and Alana Farrell and Magdalena Furgalska and Antonella Lavelanet},
  journal = {BMC Public Health},
  volume = {22},
  pages = {1232},
  doi = {10.1186/s12889-022-13620-z},
  url = {https://bmcpublichealth.biomedcentral.com/articles/10.1186/s12889-022-13620-z},
}
